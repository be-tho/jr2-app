...
{{--    <link rel="stylesheet" href="{{ asset('public/build/assets/app-b1dc9b4f.js') }}">--}}
{{--    <link rel="stylesheet" href="{{ asset('public/build/assets/app-c4359d26.css') }}">--}}
...
<footer class="bg-gray-900">
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <div class="flex justify-center space-x-6 md:order-2">
            <p class="text-gray-400 text-center text-base">Página creada por AzureBeto</p>
        ...
        <div class="mt-8 md:order-1 md:mt-0">
            <p class="text-center text-base text-gray-400">
                &copy; 2023 Jr2 Derechos reservados.
            </p>
        </div>
    </div>
</footer>
